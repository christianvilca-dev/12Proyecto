...
<%@page import="pe.christian.dao.PSQLTalla"%>
<%@page import="pe.christian.modelos.Producto"%>
<%@page import="pe.christian.modelos.Talla"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>

<%
    Producto producto = (Producto) request.getAttribute("producto");
    
    // Mala practica por lo que debio estar en el servlet "producto-detalle"
  ...
  <div class="ed-item">
    ...
    <div class="ed-container product__page">
      <div class="ed-item tablet-50">
          <img src="/12ProyectoNetbeans/<%= producto.getImagen() %>" class="product__page__img"/>
      </div>
