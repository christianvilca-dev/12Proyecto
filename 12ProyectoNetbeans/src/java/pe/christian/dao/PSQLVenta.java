...
import pe.christian.excepciones.ExcepcionGeneral;
import pe.christian.modelos.Producto;
import pe.christian.modelos.VentaDetalle;
...
public class PSQLVenta {
    ...
    public VentaEncabezado insertarVenta(String nombre, String direccion, List<Producto> carro)throws ExcepcionGeneral {
    ...
    private void insertaDetalle(List<Producto> carro, VentaEncabezado encabezado) throws ExcepcionGeneral{
        try {
            ...
            for (Producto producto : carro) {
                ...
                sentencia.executeUpdate(); // si deseamos podemos obtener la cantidad de registros que se afectaron
